...
var defaultConfig = {
  ...
  webWorkerPath: '/static/cornerstone/js/dist/cornerstoneWADOImageLoaderWebWorker.js',
  webWorkerTaskPaths: [],
  taskConfiguration: {
    decodeTask: {
      loadCodecsOnStartup: true,
      initializeCodecsOnStartup: false,
      codecsPath: '/static/cornerstone/js/dist/cornerstoneWADOImageLoaderCodecs.js',
      usePDFJS: false,
